...
int main() {
	...
	cout << "O menor número do conjunto é: " << *min_element(conjunto.begin(), conjunto.end()) << endl;

	/*Análise do vetor até achar o maior valor, usando a função max_element( , ), e imprime no console esse valor*/
	cout << "O maior número do conjunto é: " << *max_element(conjunto.begin(), conjunto.end()) << endl;
